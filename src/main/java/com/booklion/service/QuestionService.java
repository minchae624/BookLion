...
public class QuestionService {
	...
	public List<Questions> searchQuestions(Integer categoryId, String keyword) {
		return questionRepository.searchByCategoryAndKeyword(categoryId, keyword);
	}

	public List<Questions> getQuestionsByUserId(Integer userId) {
	...
	@Transactional
	public Questions updateQuestion(Integer id, QuestionRequestDto dto) {
		Questions question = questionRepository.findById(id).orElse(null);
